...
class Networking{
    ...
    func uploadMultipart(route: Route, image: UIImage, parameters: [String: Any], completion: @escaping (Result<SuccessModel, AppError>) -> Void) {
...
//        let URL = try! URLRequest(url: url, method: .post, headers: headers)
        ...
        AF.upload(multipartFormData: { multipartFormData in
            ...
            multipartFormData.append(imageData ?? Data(), withName: "images", fileName: imageName, mimeType: "image/jpg")
